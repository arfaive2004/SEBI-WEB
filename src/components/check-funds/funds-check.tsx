...
export function FundsCheck() {
  ...
  const handleCheckFunds = async () => {
    ...
    try {
      const response = await fetch('https://sebi-api-rbnmeqkvlq-uc.a.run.app/api/compliance/check-funds', {
        method: 'POST',
        body: formData,
      })
    ...
    <div className="flex flex-col items-center justify-center gap-8 py-10">
      <Card className="w-full max-w-md">
        <CardHeader>
            ...
            <CardDescription>Upload the client's bank statement in CSV format to check for fund sufficiency.</CardDescription>
        </CardHeader>
